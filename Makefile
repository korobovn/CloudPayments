...
.SILENT : help install shell test test-feature
.DEFAULT_GOAL : help
...
test-feature: ## Execute php feature tests
	$(docker_bin) run $(RUN_ARGS) $(RUN_INTERACTIVE) "$(PHP_IMAGE)" bash -c "composer test-feature"
